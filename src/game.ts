...
script1.spawn(imageFromURL5, {"image":"https://ipfs.io/ipfs/QmdD9z4Yh9Dd4jYhCFinJ2jn3RgLrmJZmeAG7tiZ7RZoEs?filename=wal1.webp"}, createChannel(channelId, imageFromURL5, channelBus))
script1.spawn(imageFromURL6, {"image":"https://cdn.corporate.walmart.com/dims4/WMT/71169a3/2147483647/strip/true/crop/2389x930+0+0/resize/980x381!/quality/90/?url=https%3A%2F%2Fcdn.corporate.walmart.com%2Fd6%2Fe7%2F48e91bac4a8ca8f22985b3682370%2Fwalmart-logos-lockupwtag-horiz-blu-rgb.png"}, createChannel(channelId, imageFromURL6, channelBus))
...
script11.init()
script22.init()
script11.spawn(imageBillboardBlack, {"image":"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSAQoXljfddR6VqKYzBNnWI11GhI3ETFPjwxVGsoVUYiTMtZdPEBn6H8l8zCU3c1SWqqVY&usqp=CAU"}, createChannel(channelId1, imageBillboardBlack, channelBus1))
script22.spawn(imageScreen, {"image":"https://i5.walmartimages.com/dfw/63fd9f59-6777/55a44c7e-2201-4ca4-aa1a-b3556b2a6886/v1/wplus_background_bag.png"}, createChannel(channelId1, imageScreen, channelBus1))
